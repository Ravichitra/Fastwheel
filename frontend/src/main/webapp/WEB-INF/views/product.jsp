...
<div class="container">
<c:if test="${editmode}">
<c:set var="url" value="${cr2}/updateproduct"></c:set>
</c:if>
<c:if test="${!editmode}">
<c:set var="url" value="${cr2}/CreateProduct"></c:set>
</c:if>
	<c:if test="${haserror}">
	...
	<div class="ntry">
		<h2>PRODUCT FORM</h2>
		<form:form class="form-horizontal" modelAttribute="product" enctype="multipart/form-data" action="${url}" method="post" >
		<c:if test="${editmode}">
				<div class="form-group">
					<label class="control-label col-sm-2" for="prd">PRODUCT
						ID:</label>
					<div class="col-sm-10">
						<form:input type="text" class="form-control" id="prd"
							 name="prd" path="product_id"
							readonly="true" />
					</div>
				</div>
			</c:if>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<form:input type="text" class="form-control" id="prd"
						placeholder="product description" name="prd" path="productDesc" />
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<label class="control-label col-sm-2" for="prd">QUANTITY:</label>
				<div class="col-sm-10">
					<form:input type="text" class="form-control" id="prd"
						  path="quantity" />
				</div>
			...
			<div class="form-group">
				<form:errors path="quantity" cssStyle="color:red"></form:errors>
				<label class="control-label col-sm-2" for="prd">PRICE:</label>
				<div class="col-sm-10">
					<form:input type="text" class="form-control" id="prd"
						 name="prd" path="price" />
						...
						<tbody>
							<c:forEach items="${prodlist}" var="c">
								<tr>
									...
									</a> <a href="${cr2}/deleteproduct?product_Name=${c.product_Name}"
										rel="tooltip"
