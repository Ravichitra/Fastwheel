...
<c:set var="CR" value="${pageContext.request.contextPath}/resources/productimages" />
...
<div class="container">
	<c:if test="${empty(cartlist)}">
		...
		<a href="${contextroot}/viewproducts" class="btn button"><i
	...
	<c:if test="${!empty(cartlist)}">
		<table id="cart" class="table table-hover table-condensed">
					...
					<tr>
						<td data-th="Product">
							<div class="row">
								...
								<div class="col-sm-8">
									<h4 class="nomargin" style="padding-top: 50px;">${l.product_Name}</h4>
								</div>
							</div>
						</td>
						...
						<td class="actions" data-th=""><a
							href="${contextroot }/user/deleteitem?itemid=${l.noid}"
			...
			<tfoot>
				<tr>
					<td><a href="${contextroot}/viewproducts"
